...
//		foreach($dataHead as $key=>$value){
	...
	$dataHead[1]="<a id='thLink' href='dealWithInters.php?order_key=".$dataHead[1]."'>".$dataHead[1]."</a>";
	...
	$dataHead[4]="
				...
				<a id='thLink' href='dealWithInters.php?order_key=".$dataHead[4]."'>".$dataHead[4]."</a>
				<img src='image/date_32.png' width='10%' height='10%' onclick='selectDate()'/>
				</div>";
	$dataHead[5]="<a id='thLink' href='dealWithInters.php?order_key=".$dataHead[5]."'>".$dataHead[5]."</a>";
	//$dataHead[2]="";
	/*
	$dataHead[3]="
	<ul class='type'>
	...
	*/
	...
	$insert="(<a href='insertUpdate/index.php'>添加记录</a>)";
