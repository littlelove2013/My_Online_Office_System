            	...
            	<tr align="center" valign="middle">
                	<td align="center">
                    	<?php 
							...
							echo "&nbsp;&nbsp;";
							if($this->pages > 1){
								echo "<a href='http://localhost/test_TD_OA/Funds/showFunds.php?pages=1'>首&nbsp;页</a>&nbsp;";
								echo "<a href='http://localhost/test_TD_OA/Funds/showFunds.php?pages=".($this->pages-1)."'>上一页</a>&nbsp;";
							}
							if($this->pages< $this->pageTotal){
								echo "<a href='http://localhost/test_TD_OA/Funds/showFunds.php?pages=".($this->pages+1)."'>下一页</a>&nbsp;";
								echo "<a href='http://localhost/test_TD_OA/Funds/showFunds.php?pages=".($this->pageTotal)."'>尾&nbsp;页</a>";
							}
						 ?>
                    </td>
                </tr>
...
<script language="javascript">
	function goNum(){
		...
		location.href = "http://localhost/test_TD_OA/Funds/showFunds.php?pages="+num;
	}
</script>
</html>
