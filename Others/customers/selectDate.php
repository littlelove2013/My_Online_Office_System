...
<body>
	<div id='selecttime' style="text-align:center">
        ...
        起始日期:<input type="datetime-local" id="startTime" pattern="起始日期" />
        <br/>
        <br/>
        结束日期:<input type="datetime-local" id="endTime" pattern="结束日期" />
        <p>
...
<script language="javascript">
	...
	function selectDate(){
		...
		var html="dealWithInters.php?startTime="+startTime+"&endTime="+endTime;
